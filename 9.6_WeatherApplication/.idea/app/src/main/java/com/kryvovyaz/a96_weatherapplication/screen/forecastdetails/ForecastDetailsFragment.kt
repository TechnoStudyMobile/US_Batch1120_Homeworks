...
class ForecastDetailsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // forecastViewModel.getForecastContainer(Application.prefs!!.icCelsius, Application.prefs!!.days)
    ...
    override fun onResume() {
        super.onResume()
        forecastViewModel.fetchForecastContainer(Application.prefs!!.icCelsius, Application.prefs!!.days)
        getForecastDetails()
    }
}